...
export const SettingsModal: React.FC<SettingsModalProps> = ({ settings, onSave, onClose, isOnboarding = false }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-md animate-in fade-in zoom-in duration-200 border border-slate-100 dark:border-slate-800">
